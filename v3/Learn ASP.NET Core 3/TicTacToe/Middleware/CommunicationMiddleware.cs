...
namespace TicTacToe.Middleware
{
	public class CommunicationMiddleware
	{
		...
		public async Task Invoke(HttpContext context)
		{
			if ( context.WebSockets.IsWebSocketRequest )
			{
				...
				switch ( command.Operation.ToString () )
				{
					...
					{
						await ProcessEmailConfirmation ( context, webSocket, ct, 
		...
		public async Task ProcessEmailConfirmation ( HttpContext context, WebSocket currentSocket, 
			CancellationToken ct, string email )
		{
